<title>Administrar Reservas de Recursos - WinKnow</title>
    ...
    <div class="contenido">
        ...
        <section class="estadisticas">
            <div class="tarjeta-estadistica">
                <div class="icono total"><i class="bi bi-box-seam"></i></div>
                <div>
                    <h3 data-lang="pending_resource_reservations">Reservas de Recursos Pendientes</h3>
        ...
        <section class="aulas">
            <div class="aulas-header">
                <h2><i class="bi bi-list-check"></i> <span data-lang="resource_reservation_management">Gestión de Reservas de Recursos</span></h2>
                    ...
                    <?php while ($reserva = $resultReservas->fetch_assoc()): ?>
                        <div class="tarjeta-reserva-admin">
                            ...
                            <div class="reserva-acciones">
                                <form method="POST" action="administrar_reservas_recursos.php" class="form-aprobar">
                                ...
                                <form method="POST" action="administrar_reservas_recursos.php" class="form-rechazar">
            ...
            <?php else: ?>
                <div class="mensaje-vacio">
                    ...
                    <p data-lang="no_pending_resource_reservations">No hay reservas de recursos pendientes en este momento.</p>
                </div>
            <?php endif; ?>
        </section>
