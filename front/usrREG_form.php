...
<div class="form-overlay">
    <form id="registroForm" class="form-flotante" method="post" action="register.php">
        <div class="form-header-with-back">
            <p class="cursor typewriter-animation" data-lang="add_users">AÑADIR USUARIOS</p>
            <a href="../admin/usuarios.php" class="btn-back">
        ...
        <!-- Selección de tipo -->
        <label for="operacion" data-lang="select_user_type">Seleccione tipo de usuario</label>
        <select name="operacion" id="operacion" required>
            <option value="" data-lang="select">-- Seleccione --</option>
            <option value="docente" data-lang="teacher">Docente</option>
            <option value="estudiante" data-lang="student">Estudiante</option>
        </select>
        <br>
        <div id="divDeInputs" class="input-field"></div>

        <button type="submit" data-lang="register">Registrar</button>
        <br>
    </form>
